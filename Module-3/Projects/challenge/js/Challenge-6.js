...
fridge.push('Apple','Dr Pepper','Ham','Turkey','Chicken')
...
//Write a function that will remove an item from the fridge, and put it in the
...
//Write a function that will remove the last item in the buyList, 
